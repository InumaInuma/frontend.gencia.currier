              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-amber-300/90 text-[11px] mt-0.5 leading-relaxed">
                    Los envíos agendados después de las <strong>09:30 AM</strong> se programan para entrega el siguiente día hábil. Si el motorizado aún no ha pasado a recoger a tu comercio hoy, el administrador podrá asignarlo a la ruta de hoy.
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="bg-slate-900/40 border border-slate-900 rounded-2xl p-5 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-900">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                <button
                  onClick={() => { const today = getTodayFormatted(); setFechaInicio(today); setFechaFin(today); }}
            ...
            {loadingPedidos ? (
              <div className="text-center py-12 text-slate-400 text-sm">Cargando historial de envíos...</div>
